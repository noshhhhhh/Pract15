...
<head>
    <meta charset="UTF-8">
    <title>IntroPhp7 Grupo XC - Alfredo Rodriguez Garcia</title>
...
tercera parte, ¿su densidad sería la misma? ¿por qué?</p>
</section>
...
<?php
 print "<h1> resultado: densidad = ".calcula_densidad(). " kg/(metro cúbico)</h1>";
?>
</section>
</section>
    <footer class="pie">
